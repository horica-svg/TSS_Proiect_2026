class TaxEngine:
    ...
    def calculate_annual_tax(self, income, category, age, is_resident, has_dependents=False, is_married=False):
        ...
        if category == "salary":
            ...
            tax = income * 0.10
            if income > 10000:
                tax += (income - 10000) * 0.20  # Supra-taxare pentru castiguri mari din crypto
            if not is_resident:
                tax = tax * 1.5  # Penalizare pentru non-rezidenti care tranzactioneaza crypto in tara
