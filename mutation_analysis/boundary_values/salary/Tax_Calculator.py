'''
Am schimbat linia 54 din:
    if income <= 10000 -> if income < 10000
    
Acest mutant verifica daca exista teste pentru valorile de frontiera.

Testul test_salary_first_bracket a picat:
FAILED tests/functional-testing/test_functional_tax_calculator.py::TestFunctionalTaxCalculator::test_salary_first_bracket - AssertionError: 0 != 1000.0
'''
